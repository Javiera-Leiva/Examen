...
export class Bebidas extends Component{
    ...
    refreshList(){
        ...
        .then(response=>response.json())
        .then(data=>{
            this.setState({categorias2:data});
        });
    }
    ...
    changeCategoria =(e)=>{
        this.setState({Categoria_Bebida:e.target.value});
    }
    ...
    editClick(b){
        this.setState({
            ...
            NombreB:b.NombreB,
            Categoria_Bebida:b.Categoria_Bebida,
    ...
    createClick(){
        fetch(variables.API_URL+'bebida',{
            ...
            body:JSON.stringify({
                ...
                Categoria_Bebida:this.state.Categoria_Bebida,
    ...
    <div className="d-flex flex-row bd-highlight mb-3">
     ...
     <div className="p-2 w-50 bd-highlight">
        ...
        <div className="input-group mb-3">
            <span className="input-group-text">ProductoNombre</span>
        ...
        <div className="input-group mb-3">
            ...
            value={Categoria_Bebida}>
                {categorias2.map(b=><option key={b.Id_Bebida}>
                    {b.CategoriaB}
                </option>)}
            </select>
        </div>
