...
export class Plato extends Component {
    ...
    changeCategoria = (e) => {
        this.setState({ Id_CategoriaPlato: e.target.value });
    }
    ...
    editClick(b) {
        this.setState({
            ...
            Id_Plato:b.Id_Plato,
            NombreP:b.NombreP,
            Id_CategoriaPlato:b.Id_CategoriaPlato,
    ...
    updateClick(id) {
        fetch(variables.API_URL + 'Plato/' + id, {
            method: 'PUT',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json'
                            ...
                            <tr key={b.Id_Plato}>
                                ...
                                <td>
                                    ...
                                    <button type="button"
                                        ...
                                        onClick={() => this.deleteClick(b.Id_Plato)}>
                        ...
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                ...
                                {Id_Plato !== 0 ?
                                    <button type="button"
                                        className="btn btn-primary float-start"
                                        onClick={() => this.updateClick(Id_Plato)}
                                    >Actualizar</button>
                                    : null}
                            </div>
                        </div>
